...
const CoachProfileView = () => {
  ...
  if (error || !coach) {
    return (
      <div className="text-center py-16">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-2">No Coach Assigned</h3>
        <p className="text-gray-500">A coach will be assigned to you soon.</p>
        <button 
  ...
  const stats = [];
  if (coach.experience) {
    stats.push({ label: 'Years Experience', value: coach.experience, icon: Award, color: 'amber' });
  }
  if (coach.successRate) {
    stats.push({ label: 'Success Rate', value: coach.successRate, icon: TrendingUp, color: 'green' });
  }
        ...
        <div className="relative px-6 py-8 flex flex-col md:flex-row items-center gap-6">
          ...
          <div className="text-center md:text-left flex-1">
            ...
            <div className="flex flex-wrap gap-2 mt-3 justify-center md:justify-start">
              ...
              {coach.createdAt && (
                <span className="px-3 py-1 bg-white/10 backdrop-blur-sm rounded-full text-xs font-medium text-white">
                  Since {formatDate(coach.createdAt)}
                </span>
              )}
            </div>
          </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {coach.bio && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="font-semibold text-gray-800">About Coach</h3>
              </div>
          ...
          {specialties.length > 0 && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="font-semibold text-gray-800">Specialties & Expertise</h3>
              </div>
          ...
          {!coach.bio && specialties.length === 0 && certifications.length === 0 && !coach.experience && !coach.successRate && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 text-center">
              ...
              <p className="text-gray-500">Your coach hasn't added their profile details yet.</p>
              <p className="text-sm text-gray-400 mt-1">Send them a message to learn more!</p>
            </div>
          )}
        </div>
